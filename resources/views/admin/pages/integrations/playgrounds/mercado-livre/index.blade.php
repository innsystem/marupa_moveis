                        ...
                        <div class="row align-items-center">
                            <div class="col-6 col-md-3 col-lg-3 mb-2">
                                ...
                                <select id="type" name="type" class="form-control">
                                    ...
                                    <option value="top_products">Top Ofertas</option>
                                </select>
                            </div>
                            <div class="col-12 col-md-3 col-lg-3 mb-2">
                                <!-- <label for="query">Palavra chave do Produto:</label> -->
                                <input type="text" id="query" name="query" class="form-control" placeholder="Ex: Nome do Produto">
                            </div>
                            @if(isset($categoriesMercadoLivre))
                            <div class="col-12 col-md-3 col-lg-4 mb-2 input_products_offers">
                                <select name="category" id="category" class="form-select select2">
                                    <option value=""></option>
                                    @foreach($categoriesMercadoLivre as $category)
                            ...
                            <div class="col-12 col-md-3 col-lg-2 mb-2">
                                <div class="form-group">
                                    <input class="form-check-input" type="checkbox" name="freeShipping" value="1" id="freeShipping" checked>
                                    <label class="form-check-label" for="freeShipping">Frete Grátis?</label>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-1">
