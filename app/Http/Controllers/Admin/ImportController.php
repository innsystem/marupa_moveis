    ...
    public function importData(Request $request)
    {
        try {
            ...
            if (json_last_error() !== JSON_ERROR_NONE) {
                return back()->with('error', 'Erro ao decodificar o arquivo JSON: ' . json_last_error_msg());
            }
            ...
            return back()->with('success', 'Importação concluída com sucesso. ' . 
                "Importados: {$results['users']} clientes, {$results['services']} serviços, {$results['invoices']} faturas.");
                ...
                foreach ($clienteData['servicos'] as $servicoData) {
                    ...
                    if (!$userService) {
                        ...
                        $metadata = [
                            ...
                            'ftp' => $servicoCliente['ftp'] ?? null,
                            'ftp_login' => $servicoCliente['ftp_login'] ?? null,
                            'ftp_password' => $servicoCliente['ftp_password'] ?? null,
                        ];
                    ...
                    if (!$invoice) {
                        ...
                        foreach ($descriptions as $index => $description) {
                            ...
                            if (isset($serviceIds[$index])) {
                                $invoiceItem->target_type = UserService::class;
